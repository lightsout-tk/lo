  ...
  var warveSurferInit = function () {
    ...
    if ($(".playlist .media-url").length > 0) {
      ...
      var setTrackTitle = function (url) {
        ...
        if ($thisTrack.find(".track-image").attr("src") !== undefined) {
          $trackImage = $thisTrack.find(".track-image").attr("src");
        } else if ($(".album-image").length) {
          $trackImage = $(".album-image").attr("src");
        }
  ...
  */
  ...
  window.waveSurgerPlaylist = function () {
    if ($(".playlist .media-url").length) {
      ...
      var tracksImages = $(".playlist .track-image");
      if (
